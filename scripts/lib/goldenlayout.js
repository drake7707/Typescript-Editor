(function ($) {
    ...
    lm.utils.copy(lm.items.Root.prototype, {
        ...
        setSize: function (w, h) {
            var width = typeof w === "undefined" ? this._containerElement.width() : w,
                height = typeof h === "undefined" ? this._containerElement.height() : h;
    ...
    lm.utils.copy(lm.items.RowOrColumn.prototype, {
        ...
        _onSplitterDragStart: function (splitter) {
            ...
            this.layoutManager.emit("splitterDragStart");
        },
        ...
        _onSplitterDrag: function (splitter, offsetX, offsetY) {
            ...
            this.layoutManager.emit("splitterDrag");
        },
